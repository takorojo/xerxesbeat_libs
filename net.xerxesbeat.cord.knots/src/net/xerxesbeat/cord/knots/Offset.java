...
public class Offset<T extends Number> extends Knot
{
	public Offset ()
	{
		tie( "output", new Cord () );
	...
	public Offset ( T addition )
	{
		tie( "offset", addition );
		tie( "output", new Cord () );
	}

	public Offset ( Cord<T> addition )
	{
		tie( "offset", addition );
		tie( "output", new Cord () );
	}
	...
	public void event ( Event event )
	{
		if ( event instanceof UpdateEvent )
		{
			...
			{
				Object x = cord.get();
				tug( "output" ).set( offset( x, tug( "offset" ).get() ) );
			}
		}
	}

	private Object offset ( Object a, Object b )
	{
